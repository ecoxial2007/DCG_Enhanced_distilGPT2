...
from tools.dataset.mimic_cxr_dataset_forme import Subset
from medsam2distilgpt2_mimic_cxr import MedSAM2DistilGPT2MIMICXR
...
def train(model, args, train_dl, test_dl, optimizer, scaler, lr_scheduler=None):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch >= 0:
            ...
            if test_scores[monitor] - best_score > 0.0001:
...
def main(args):
    ...
    model = MedSAM2DistilGPT2MIMICXR(**vars(args))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", default="./config/train_mimic_cxr.yaml")
    parser.add_argument("--epochs", default=20)
    parser.add_argument("--device", default="cuda:0")
    parser.add_argument("--work_dir", default='./experiments/mimic_cxr')
