...
class MedSAM2DistilGPT2IUXRay(LightningModule):
    def __init__(
            self,
        ...
        self.wd = wd
        print('start loadding model..')
        # Paths:
        self.labels_file_path = os.path.join(self.dataset_dir, "iu_x-ray", "annotation_top5.json")
        ...
        # self.text_encoder = decoder.transformer
